...
/* CLINT 寄存器偏移 */
#define CLINT_MTIMECMP  0x4000      /* mtimecmp 寄存器偏移 (每个 hart 8 字节) */
#define CLINT_MTIME     0xBFF8      /* mtime 寄存器偏移 */

/* 获取 hart 的 mtimecmp 地址 */
#define CLINT_MTIMECMP_ADDR(hartid) (CLINT + CLINT_MTIMECMP + 8 * (hartid))
